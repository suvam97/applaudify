    ...
    <div className='row g-0'>
      <div className='col-6'>
        ...
        >
          ...
          <span className='fs-5 fw-bold text-gray-800 mb-0'>Jury Board</span>
          <span className='fs-7 text-gray-400'>Jury Scoring</span>
        </a>
      </div>
      ...
      <div className='col-6'>
        ...
        >
          ...
          <span className='fs-5 fw-bold text-gray-800 mb-0'>CC Board</span>
          <span className='fs-7 text-gray-400'>Admin Page</span>
        </a>
      </div>
